"""Download ECOSTRESS L2T LSTE granules for the Phoenix pilot.

This script searches NASA Earthdata for ECO_L2T_LSTE V002 granules within the
fixed Phoenix pilot domain and time window from config.py. Successful downloads
are saved under data/raw/ecostress_lst/ and recorded in manifest.csv.
"""
...
DATASET = "ECOSTRESS Tiled Land Surface Temperature and Emissivity"
SHORT_NAME = "ECO_L2T_LSTE"
VERSION = "002"
SOURCE = "NASA LP DAAC Earthdata"
RAW_SUBDIR = "ecostress_lst"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Search and download ECO_L2T_LSTE V002 granules for Phoenix 2023."
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
...
def main() -> None:
    ...
    print("Searching for ECOSTRESS LST granules...")
